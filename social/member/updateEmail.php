...
<body>
  ...
  <div class="user">
    <header class="user__header">
        ...
        <h1 class="user__title">更改EMAIL </h1>
    </header>

    <form class="form" method="post" action="updateEmail_finish.php">
      <button class="btn" onclick= history.back() type="button"/>回上一頁</button>
        <div class="form__group">
            <input type="text" placeholder="請輸入新的email" class="form__input" name="email"  />
        </div>
